...
export const titleLevel: Record<gradeNames, number[]> =
{
    ...
    '핑아일체': [10, 0, 0, 10, 0, 0, 5, 0, 0, 10, 0, 0, 0, 0],
    '예티X핑크빈': [20, 0, 0, 20, 0, 0, 10, 0, 0, 10, 0, 0, 0, 0],
    '헤이스트': [50, 0, 0, 50, 0, 0, 20, 0, 0, 30, 0, 30, 0, 0],
}

export const titleLevel_xenon: Record<gradeNames, number[]> =
{
    '킹 오브 루타비스': [24, 0, 0, 0, 0, 0, 3, 0, 0, 5, 0, 5, 0, 0],
    '핑아일체': [30, 0, 0, 0, 0, 0, 5, 0, 0, 10, 0, 0, 0, 0],
    '예티X핑크빈': [60, 0, 0, 0, 0, 0, 10, 0, 0, 10, 0, 0, 0, 0],
    '헤이스트': [150, 0, 0, 0, 0, 0, 20, 0, 0, 30, 0, 30, 0, 0],
}

export const titleLevel_demon: Record<gradeNames, number[]> =
{
    '킹 오브 루타비스': [300, 0, 0, 8, 0, 0, 3, 0, 0, 5, 0, 5, 0, 0],
    '핑아일체': [0, 0, 0, 10, 0, 0, 5, 0, 0, 10, 0, 0, 0, 0],
    '예티X핑크빈': [0, 0, 0, 20, 0, 0, 10, 0, 0, 10, 0, 0, 0, 0],
    '헤이스트': [2500, 0, 0, 50, 0, 0, 20, 0, 0, 30, 0, 30, 0, 0],
}
